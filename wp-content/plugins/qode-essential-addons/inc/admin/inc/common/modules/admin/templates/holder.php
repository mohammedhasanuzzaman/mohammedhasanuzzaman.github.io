				...
				<div class="qodef-header-left-inner">
					<div class="qodef-logo-holder">
						<a href="https://qodeinteractive.com" target="_blank">
							<img src="<?php echo esc_url( QODE_ESSENTIAL_ADDONS_ADMIN_URL_PATH . '/inc/common/modules/admin/assets/img/logo-qode-interactive.png' ); ?>" alt="<?php esc_attr_e( 'Admin Qode Interactive image', 'qode-essential-addons' ); ?>"/>
						</a>
					</div>
					<div class="qodef-help-center-holder">
						<a href="https://helpcenter.qodeinteractive.com" target="_blank">
							<img class="qodef-help-image" src="<?php echo esc_url( QODE_ESSENTIAL_ADDONS_ADMIN_URL_PATH . '/inc/common/modules/admin/assets/img/help-center-icon.png' ); ?>" alt="<?php echo esc_attr__( 'Help Center Icon image', 'qode-essential-addons' ); ?>"/>
