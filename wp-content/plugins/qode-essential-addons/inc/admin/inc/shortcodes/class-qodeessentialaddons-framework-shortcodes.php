...
class QodeEssentialAddons_Framework_Shortcodes {
	...
	private function set_shortcode( QodeEssentialAddons_Framework_Shortcode $shortcode ) {
	...
	public function add_shortcode( QodeEssentialAddons_Framework_Shortcode $shortcode ) {
	...
	public function register() {
		do_action( 'qode_essential_addons_action_framework_before_shortcodes_register' );
		...
		do_action( 'qode_essential_addons_action_framework_after_shortcodes_register' );
	}
}
